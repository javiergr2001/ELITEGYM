            ...
            <div class="container ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 m-auto mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="view/conócenos.html">Conócenos</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="modal-body">
                    <form class="m-auto" method="POST" action="controller/Login.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="inputPassword" name="contrasenalogin" placeholder="Escribe tu contraseña...">
                        </div>
                        ...
                        <div class="accordion mt-2" id="accordionExample">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>
                                            Es un programa de ejercicios que combina música latina e internacional con
                                            movimientos de baile. Las rutinas de Zumba incorporan el entrenamiento por
                                            intervalos en el que se alternan ritmos rápidos y lentos para ayudar a
                                            mejorar
                                            el
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>La música salsa es una mezcla de los sonidos africanos y caribeños. Estos son
                                            sonidos
                                            como el son, mambo, bomba y plena. Salsa es un término que describe varios
                                            estilos
                                            rítmicos e instrumentales que se originaron no solo en Puerto Rico, pero
                                            también
                                            en
                                            Cuba, Republica Dominicana, y sí, Los Estados Unidos</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <P>El step es una actividad física variante del aeróbic que consiste en la
                                            realización
                                            de una secuencia de ejercicios sobre un escalón, denominado step.</P>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <P>Es un ejercicio aeróbico y cardiovascular que se realiza sobre una bicicleta
                                            estática
                                            en el que se trabaja el tren inferior: las piernas y los glúteos. Su
                                            finalidad
                                            principal es perder peso y la tonificación de los músculos, además de
                                            mejorar la
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapsefive" class="accordion-collapse collapse" aria-labelledby="headingfive" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <P>El boxeo es un deporte de contacto que consiste en golpear con los puños con
                                            guantes
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapsesix" class="accordion-collapse collapse" aria-labelledby="headingsix" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <P>El Body Pump es un programa de entrenamiento físico intenso que combina
                                            actividad
                                            aeróbica y trabajo muscular mediante el levantamiento de pesas al ritmo de
                                            la
                                            música.
                                            Son sesiones dirigidas, divertidas y motivadoras, en las que se fortalece el
                                            sistema
                                            cardiovascular y la gran mayoría de los músculos del cuerpo</P>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
